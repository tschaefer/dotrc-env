...
_gh_issue_edit()
{
    ...
    local_nonpersistent_flags+=("--add-assignee=")
    flags+=("--add-label=")
    two_word_flags+=("--add-label")
    local_nonpersistent_flags+=("--add-label")
    local_nonpersistent_flags+=("--add-label=")
    flags+=("--add-project=")
    two_word_flags+=("--add-project")
    local_nonpersistent_flags+=("--add-project")
    local_nonpersistent_flags+=("--add-project=")
    flags+=("--body=")
    two_word_flags+=("--body")
    two_word_flags+=("-b")
    ...
    local_nonpersistent_flags+=("--remove-assignee=")
    flags+=("--remove-label=")
    two_word_flags+=("--remove-label")
    local_nonpersistent_flags+=("--remove-label")
    local_nonpersistent_flags+=("--remove-label=")
    flags+=("--remove-project=")
    two_word_flags+=("--remove-project")
    local_nonpersistent_flags+=("--remove-project")
    local_nonpersistent_flags+=("--remove-project=")
    flags+=("--title=")
    two_word_flags+=("--title")
    two_word_flags+=("-t")
...
_gh_pr_edit()
{
    ...
    local_nonpersistent_flags+=("--add-project=")
    flags+=("--add-reviewer=")
    two_word_flags+=("--add-reviewer")
    local_nonpersistent_flags+=("--add-reviewer")
    local_nonpersistent_flags+=("--add-reviewer=")
    flags+=("--body=")
    two_word_flags+=("--body")
    two_word_flags+=("-b")
    ...
    two_word_flags+=("--remove-reviewer")
    local_nonpersistent_flags+=("--remove-reviewer")
    local_nonpersistent_flags+=("--remove-reviewer=")
    flags+=("--title=")
    two_word_flags+=("--title")
    two_word_flags+=("-t")
...
_gh_pr_merge()
{
    ...
    local_nonpersistent_flags+=("-d")
    flags+=("--disable-auto")
    local_nonpersistent_flags+=("--disable-auto")
    flags+=("--merge")
    flags+=("-m")
